...
export function Footer() {
  ...
  return (
    <footer className="bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 pt-16 pb-8 px-6 md:px-12 lg:px-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#contact" className="text-slate-600 dark:text-slate-400 hover:text-emerald-500 transition-colors">Contact</Link></li>
            </ul>
          </div>
